...
#### 🖥️ Frontend
- React javascript - good for interactive user interfaces (javascript, needs node)
...
Read the guide here for runnning the Frontend code
...
Read the guide here for runnning the Backend code


| Section 2 | Description                                                   |
| --------- | ------------------------------------------------------------- |
| 1         | [Python](./python-starter/README.md)                          |
